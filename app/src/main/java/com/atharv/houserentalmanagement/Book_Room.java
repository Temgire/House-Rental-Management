...
public class Book_Room extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference=db.collection("Rooms").document(Name);
        ...
        db.collection("Rooms")
                ...
                .addOnSuccessListener(new OnSuccessListener() {
                    ...
                    public void onSuccess(Object o) {
                        Toast.makeText(Book_Room.this, "Booked Successfully", Toast.LENGTH_SHORT).show();
                        book.setText("Booked");
                    ...
                    public void onFailure(@NonNull Exception e) {
                        recreate();
                        Toast.makeText(Book_Room.this, "Unable to book an error occurred", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}